...
export function navigationCommands(): AppCommand[] {
  return [
    ...
    listCommand("folder.enter", "Open Focused Item", (context) =>
      context.list.enterOrOpenFocused(),
    ),
    ...
    listCommand("selection.toggleNext", "Toggle and Move Down", (context) =>
      context.list.toggleFocusedAndNext(),
    ),
    listCommand("selection.invert", "Invert Selection", (context) =>
      context.list.invertSelection(),
    ),
    ...
    listCommand("file.copyDirPath", "Copy Folder Path", (context) =>
      context.list.copyText("dirPath"),
    ),
    listCommand("file.copyName", "Copy Name", (context) => context.list.copyText("name")),
    listCommand("file.copyStem", "Copy Name Without Extension", (context) =>
      context.list.copyText("stem"),
    ),
    {
      id: "clipboard.clear",
      title: "Clear Transfer Clipboard",
      run: (context) => context.list.clearClipboard(),
    },
    ...
    ),
    {
      ...
      run: (context) => context.app.toggleHidden(),
    },
    {
      id: "search.content",
    ...
    { id: "region.prev", title: "Previous Region", run: (context) => context.regions.cycle(-1) },
    {
      id: "region.sidebar",
      title: "Focus Sidebar",
      run: (context) => context.regions.focus("sidebar"),
    },
    {
      id: "region.list",
      title: "Focus File List",
      run: (context) => context.regions.focus("list"),
    },
    {
      id: "sidebar.next",
      title: "Next Sidebar Item",
      run: (context) => context.regions.sidebarMove(1),
    },
    {
      id: "sidebar.prev",
    ...
    },
    {
      ...
      run: (context) => context.regions.sidebarOpen(),
    },
    {
      id: "app.activity",
      title: "Toggle Activity",
      run: (context) => context.app.toggleActivity(),
    },
    {
      id: "app.shortcuts",
      title: "Keyboard Shortcuts",
      run: (context) => context.app.openShortcuts(),
    },
    { id: "app.settings", title: "Settings", run: (context) => context.app.openSettings() },
    {
      id: "app.toggleKeyboardMode",
      title: "Toggle Yazi Mode",
      run: (context) => context.app.toggleKeyboardMode(),
    },
